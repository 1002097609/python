...
def _call_longcat(title: str, content: str, platform: str = "", category: str = "") -> Optional[dict]:
    ...
    try:
        ...
        logger.error(f"LongCat 返回 JSON 解析失败: {e}, 原始内容: {text_content[:300]}")
        return None
