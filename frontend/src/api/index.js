...
// 解包后端统一响应格式 {code, message, data} → 直接返回 data 内容
...
// api 和 aiApi 共用同一套拦截器
api.interceptors.response.use(unpackResponse, handleError)
aiApi.interceptors.response.use(unpackResponse, handleError)
